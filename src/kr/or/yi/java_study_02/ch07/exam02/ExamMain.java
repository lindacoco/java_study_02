...
public class ExamMain {
	...
	private static Student getUpdateStudent(StudentManagement sm) {
		...
		Student searchedStd =sm.searchStudent(findStd);
		System.out.println(searchedStd);
		if (searchedStd==null) {
			...
			searchedStd.setKor(Integer.parseInt(resArr[0].trim()));
			searchedStd.setEng(Integer.parseInt(resArr[1].trim()));
			searchedStd.setMath(Integer.parseInt(resArr[2].trim()));
			return searchedStd;
		}
	}
